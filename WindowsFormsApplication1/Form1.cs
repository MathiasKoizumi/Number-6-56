	...
	public class Form1 : Form
	{
		...
		public void FlashMob(int p)
		{
			...
			case 1:
			{
				...
				if (junkie.Next(2) == 0)
				{
					gfx.DrawImage(image2, 600 - image2.Width / 2, 500 - image2.Width / 2, (float)((double)image2.Width * 1.5), (float)((double)image2.Height * 1.5));
				}
				break;
			}
			case 0:
			{
				...
				if (junkie.Next(2) == 0)
				{
					gfx.DrawImage(image, 500 - image.Width / 2, 200 - image.Width / 2, (float)((double)image.Width * 2.5), (float)((double)image.Height * 2.5));
				}
				break;
			}
			}
